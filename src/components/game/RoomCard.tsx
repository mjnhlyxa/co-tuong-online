  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="shrink-0 flex items-center gap-1 text-xs font-semibold text-[var(--c-accent)] group-hover:text-[var(--c-accent-h)] transition-colors bg-[var(--c-accent-bg)] px-2.5 py-1.5 rounded-lg">
          Vào chơi
